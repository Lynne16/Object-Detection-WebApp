...
function modelLoaded(){
    ...
    status=true;
    objectDetector.detect(micro,gotResult);
}
...
function draw(){
    ...
    if(status != ""){
        ...
        for(var i=0; i < b_objects.length; i++){
            ...
            document.getElementById("info").innerHTML="The cocossd model has detected 1 things,cocossd got the it correct";
        }
    }
}